...
# If True Train the model, else skip training.
_C.TRAIN.UPPER_BOUND = False

_C.TRAIN.TEACHER = False
...
_C.TRAIN.MULTI_VIEW = False

_C.TRAIN.MULTI_VIEW_FUSION = False
...
_C.TRAIN.CLIP_GRADIENT_NORM = 20

_C.TRAIN.NUM_SEGMENTS = 4
...
# Loss function.
_C.MODEL.COMBINATION = False
# Model architectures that has one single pathway.
_C.MODEL.SINGLE_PATHWAY_ARCH = ["c2d", "i3d", "slow", "x3d", "TSM", "MSG3D", "i3d_nopool", "mvit", "uniformer"]
...
# if the dataset is cropped in advance
_C.DATA.CROPPED = False
...
_C.DATA_LOADER.RETURN_IDX = False
